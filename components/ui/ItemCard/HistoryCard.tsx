  ...
  return (
    <li className="pb-10 flex gap-10">
      <div className="w-4 flex flex-col items-center relative">
        ...
        <span className="block rounded-lg bg-black w-[1px] h-24 absolute top-4"></span>
      </div>
      <div>
        <h3 className="text-lg md:text-[22px] leading-relaxed md:leading-[160%] mt-10 md:mt-0 text-accentColor">
          {date}
        </h3>
