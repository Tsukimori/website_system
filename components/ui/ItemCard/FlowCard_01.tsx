...
const FlowCard = ({ step, number, title, description, index }: FlowCardProps) => {
  return (
    ...
    >
      <p className="text-lg font-extrabold font-poppins text-accentColor tracking-wide">{step}</p>
      <p className="text-5xl font-extrabold font-poppins text-accentColor tracking-wider pt-1">{number}</p>
      <h3 className="text-lg font-semibold font-poppins text-accentColor mt-4 tracking-wide">{title}</h3>
