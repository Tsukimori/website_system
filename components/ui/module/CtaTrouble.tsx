...
const CtaTrouble = () => {
  ...
  return (
    <div className="py-10 md:py-16 bg-white text-center  px-6 md:px-0">
      <div className="bg-mainGreen md:w-[1200px] mx-auto text-white px-5 md:px-0 py-10 md:py-16 rounded-3xl">
        <h3 className="text-[22px] md:text-[28px]">トラブルにあってしまったら</h3>
        ...
        <ul className="bg-white text-black flex justify-center  items-center relative md:w-[558px] mx-auto my-4 rounded-full py-1 md:py-4">
            ...
            /></li>
            <li className=" text-2xl md:text-[46px] pb-1 ml-2 md:ml-4">03-5651-1122</li>
            <li><Image
        ...
        <p>受付：月～金曜日　<br className="block md:hidden"/>10:00～12:00／13:00～16:00<br className="block md:hidden"/>（年末・年始、祝日を除く）</p>
      </div>
    </div>
  );
};
