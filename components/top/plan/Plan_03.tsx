      ...
      <PageContent className="bg-bgLightBlue">
        <section className="md:w-1200 mx-auto">
          ...
          <div className="mt-0 md:mt-16 ">
            <div>
              <div className="bg-accentColor text-white p-6 rounded-t-2xl">
                <h3 className="ext-lg md:text-2xl font-bold leading-relaxed md:leading-[38.40px] mb-1 text-center">プラン_A</h3>
              </div>
          ...
          <div className="flex justify-center mt-10 md:mt-16">
            <Link href="/" className="bg-accentColor text-white cursor-pointer rounded-full flex items-center justify-center w-[350px] h-12 md:h-[58px] font-semibold">申し込む</Link>
          </div>
        </section>
        <PlanOption/>
      </PageContent>
